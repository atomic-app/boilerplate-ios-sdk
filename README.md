...
Therefore we do NOT recommend uploading this boilerplate app or any of its modifications to AppStore, or using it in the production environment. Atomic.io disclaims any and all liability for consequences of those kind of behaviours.
